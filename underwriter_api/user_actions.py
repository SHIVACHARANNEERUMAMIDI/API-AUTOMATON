...
class UserActions:
    ...
    @staticmethod
    def get_questionnaire_categories():
        """Fetch pre-registration questionnaire categories (public endpoint)."""
        return API_CLIENT.get_rest("pre-registration-questionnaire/categories", _include_auth=False)

    @staticmethod
    def get_pre_registration_questionnaire(category_ids):
        """Fetch pre-registration questionnaire details for category IDs (public endpoint)."""
        params = {"categoryIds": category_ids}
        return API_CLIENT.get_rest("pre-registration-questionnaire", params=params, _include_auth=False)
